...
urlpatterns = [
    ...
    path("seller-offers-received/<int:listing_id>",
         views.sellers_offers_list, name="seller-offers-received"),
    ...
    path("make-counter-offer/<int:offer_id>",
         views.make_counter_offer, name="make-counter-offer"),
    path("buyer-dashboard", views.view_buyer_dashboard, name='buyer-dashboard'),
     path("accept-counter-offer/<int:counter_offer_id>", views.accept_counter_offer, name='accept-counter-offer'),
    path("reject-counter-offer/<int:counter_offer_id>", views.reject_counter_offer, name='reject-counter-offer'),
